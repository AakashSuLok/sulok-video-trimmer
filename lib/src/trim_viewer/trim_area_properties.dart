...
class TrimAreaProperties {
  ...
  /// Controls how many thumbnails are shown in the same width.
  ///
  /// `1.0` means default density. Values greater than 1 show more thumbnails
  /// (smaller tile width), which gives a finer timeline preview.
  final double thumbnailDensity;
