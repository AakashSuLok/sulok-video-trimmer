...
class _FixedTrimViewerState extends State<FixedTrimViewer>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      ...
      final rawThumbCount = (trimmerActualWidth / _thumbnailViewerH) *
          widget.areaProperties.thumbnailDensity;
      _numberOfThumbnails = math.max(1, rawThumbCount.ceil());
      _thumbnailTileWidth = trimmerActualWidth / _numberOfThumbnails;
      setState(() {
        // Keep timeline width exactly equal to visible trimmer width.
        // This avoids blank strips on left/right caused by integer rounding.
        _thumbnailViewerW = trimmerActualWidth;
        ...
        _minLengthPixels = _calculateMinLengthPixels(totalDuration);
  ...
  double _calculateMinLengthPixels(Duration totalDuration) {
    ...
    // We cap min to max so rules never conflict.
    ...
    final cappedMin = widget.maxVideoLength > Duration.zero
        ...
        : widget.minVideoLength;
    final minFraction = cappedMin.inMilliseconds / totalDuration.inMilliseconds;
        ...
        children: <Widget>[
          ...
          CustomPaint(
            foregroundPainter: TrimEditorPainter(
              ...
              outsideOverlayColor: widget.editorProperties.outsideOverlayColor,
              handleWidth: widget.editorProperties.handleWidth,
              handleGripColor: widget.editorProperties.handleGripColor,
              handleHeightFactor: widget.editorProperties.handleHeightFactor,
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(
                horizontal: widget.editorProperties.visualHorizontalPadding,
