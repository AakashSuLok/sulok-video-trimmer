...
class ScrollableThumbnailViewer extends StatelessWidget {
  ...
  /// - [thumbnailWidth] is the width of each thumbnail tile in the timeline.
  ...
  /// The width of each thumbnail tile in the timeline.
  ...
  Widget build(BuildContext context) {
    return IgnorePointer(
      child: SingleChildScrollView(
        ...
        child: SizedBox(
          width: numberOfThumbnails * thumbnailWidth,
